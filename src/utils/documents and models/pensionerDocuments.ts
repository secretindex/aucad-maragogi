...
const invalidPensioner: InvalidPensioner = {
  ...
  "cr/n":
    "Comprovante de Residência atualizado (emitido a partir de agosto/2025) ou declaração conforme modelo que será disponibilizado no local do recadastramento",
  "cr/dsc":
